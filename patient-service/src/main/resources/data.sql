-- Ensure the 'patient' table exists with separate first_name and last_name columns
...
INSERT INTO patient (id, first_name, last_name, email, address, date_of_birth, date_of_registration)
